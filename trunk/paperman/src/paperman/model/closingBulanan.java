 ...
 */
@Entity
@Table(name="tr_closing_bulanan")
public class closingBulanan implements Serializable{
    @Id
    @GeneratedValue
    private Integer id;
    ...
    @Column(name="hutang_sld_awal", columnDefinition="Decimal(19,2) default '0.00'")
