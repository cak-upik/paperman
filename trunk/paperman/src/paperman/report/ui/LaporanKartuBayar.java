...
public class LaporanKartuBayar extends javax.swing.JInternalFrame {
    ...
    private List<closingBulanan> listClosingSaldoAwal;
...
//           }
    ...
    private void btnMuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMuatActionPerformed
        ...
        listClosingSaldoAwal = Main.getTransaksiService().closingBulananRecordForSaldoAwal(dateAwal.getDate());
        if (!listClosingSaldoAwal.isEmpty()) {
            getReport = Main.getReportService().getKartuPembayaranReport(new Integer(txtLambung.getText()), dateAwal.getDate(), dateAkhir.getDate(), isClosedFor.CLOSING_SALDO_AWAL, new DateTime(dateAwal.getDate()).getMonthOfYear());
        } else {
            getReport = Main.getReportService().getKartuPembayaranReport(new Integer(txtLambung.getText()), dateAwal.getDate(), dateAkhir.getDate(), isClosedFor.CLOSING_SALDO_BULAN_LALU, new DateTime(dateAwal.getDate()).minusMonths(1).getMonthOfYear());
