 ...
 * @author Nurul Chusna
 */
public class LaporanDataLambungBulananPth extends javax.swing.JInternalFrame {

    private static LaporanDataLambungBulananPth laporanDataLambungPutih;

    public static void inisialisasi() {
        laporanDataLambungPutih = new LaporanDataLambungBulananPth();
    }

    public static void destroy() {
        laporanDataLambungPutih.dispose();
        laporanDataLambungPutih = null;
        System.gc();
    }

    public static LaporanDataLambungBulananPth getLaporanDataLambungPutih() {
        return laporanDataLambungPutih;
    }

    /** Creates new form LaporanTransaksiHarian */
    public LaporanDataLambungBulananPth() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Laporan Data Kendaraan - Armada Putih");
    ...
    private void btnMuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMuatActionPerformed
        // TODO add your handling code here:
        JasperPrint getReport = Main.getReportService().getDataLambungWhiteReport(Main.getTransaksiService().setoranPutihRecord().get(0).getTglSPO(), bulan.getDate());
