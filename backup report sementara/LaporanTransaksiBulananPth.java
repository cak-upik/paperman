 ...
 * @author Nurul Chusna
 */
public class LaporanTransaksiBulananPth extends javax.swing.JInternalFrame {

    private static LaporanTransaksiBulananPth laporanBulananPutih;

    public static void inisialisasi() {
        laporanBulananPutih = new LaporanTransaksiBulananPth();
    }

    public static void destroy() {
        laporanBulananPutih.dispose();
        laporanBulananPutih = null;
        System.gc();
    }

    public static LaporanTransaksiBulananPth getLaporanTransaksiBulananPutih() {
        return laporanBulananPutih;
    }

    /** Creates new form LaporanTransaksiHarian */
    public LaporanTransaksiBulananPth() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Laporan Rekap Setoran - Armada Putih");
    ...
    private void btnMuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMuatActionPerformed
        // TODO add your handling code here:
        JasperPrint getReport = Main.getReportService().getMonthlyTransactionWhiteReport(bulan.getDate());
